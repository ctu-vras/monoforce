...
python run.py --img-paths ../config/data_sample/marv/images/1727353472_601360559_camera_front.png \
                          ../config/data_sample/marv/images/1727353472_601360559_camera_left.png \
